            ...
            <div class="row">
                <div class="col">
                    ...
                    <a href="http://raisetheageny.com/"><img class="projectpartnerlogo" src="logos/raisetheage_square.png"></a>
                            ...
                            <p>We compiled the most current findings on adolescent brain development into a report for Raise the Age NY. The research shows that the adolescent brain is different from the adult brain; it is still under development, and very sensitive to life experiences. This means that the trauma induced by incarceration can have long-lasting effects. However, it also means that the adolescent brain should be particularly amenable to rehabilitation in programs that recognize the difference between adolescents and adults. You can <a href="docs/ScAAN_RTA_report.pdf" download>download <i class="fa fa-file-pdf-o"></i></a> the full report or read it here:</p>
