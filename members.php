    ...
    <div class="jumbotron">
        <div class="container">
          <nav class="navbar navbar-toggleable-xl navbar-inverse">
             <img class="navbar-brand d-inline-block align-top" src="img/logo_notbold_white.svg" alt="">
             <a class="nav-link nav-item" href="index.php">Home</a>
             <span class="nav-link nav-item active">Members</span>
         </nav>
        ...
        <div class="col-md">
            <div class="media member">
                ...
                <div class="media-body bio">
                    <h4 class="mt-0">
                        <a href="http://wtadler.com/">William T. Adler</a>
            ...
            <div class="media member">
                ...
                <div class="media-body bio">
                    ...
                    <p>Wei Ji is Associate Professor of Neural Science and Psychology at NYU, where <a href="http://www.cns.nyu.edu/malab/">his research group</a> studies human decision-making, perception, and working memory. He is the first author of an upcoming textbook on mathematical models of behavior. Wei Ji has long-standing interests in education policy, non-profit management, and science outreach. He is the co-founder and Chairman of the Board of the <a href="http://ruralchina.org">Rural China Education Foundation</a>, a 501(c)(3) non-profit organization which aims to improve the quality of primary education in rural China through student-centered teaching methods, community-based content, and sustainable teacher professional development.</p>
                </div>
            </div>
            ...
            <div class="media member">
                ...
                <div class="media-body bio">
                    <h4 class="mt-0">Jenn Laura Lee</h4>
